...
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1002852175362"))
...
request_channel = environ.get("REQUEST_CHANNEL", "-1003046434557")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002796218560"))
