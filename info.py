...
CHANNELS = [
    ...
    for ch in environ.get("CHANNELS", "-1002810916133").split()
]
...
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1003013581751"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/allapkmodchat")
...
VERIFY_IMG = environ.get(
    "VERIFY_IMG", "https://graph.org/file/9a831688fc17466dfdc0a-486f5c24d906ed811b.jpg"
)
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://graph.org/file/493e6b664fc531f210074-04b55d01c3abc10cf0.jpg https://graph.org/file/ee0ec85a433daf428554e-a6093ed3168e74b503.jpg",
    )
).split()
...
SUBSCRIPTION = environ.get(
    "SUBSCRIPTION", "https://graph.org/file/a6d49505fe90bc492e0f7-b0a9ffcd46a4400534.jpg"
)
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
